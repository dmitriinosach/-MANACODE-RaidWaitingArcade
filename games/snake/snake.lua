...
local function paintBevel(f, r, g, b)
    f.edge:SetTexture(r * 0.40, g * 0.40, b * 0.40, 1)
    f.body:SetTexture(r, g, b, 1)
    f.hi:SetTexture(clamp1(r * 1.45), clamp1(g * 1.45), clamp1(b * 1.45), 1)
end
local function buildField(canvas)
    ...
    local deck = CreateFrame("Frame", nil, f)
...
local function buildBar(canvas)
    ...
    rule(122)
    f.clockBox = CreateFrame("Frame", nil, f)
